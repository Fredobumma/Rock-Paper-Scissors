...
const selections = Object.entries(inputSelection).map(selection => selection[1]);
...
//event listener
options.map(option => option[1].addEventListener("click", function () { 
...
function gameResult (optionValues) {
  ...
  if ((you === optionValues[0] && computer === optionValues[0]) || (you === optionValues[1] && computer === optionValues[1]) || (you === optionValues[2] && computer === optionValues[2])) { 
    result.style.color = "gray"; 
    return "It's a tie!";
  }
  if ((you === optionValues[0] && computer === optionValues[1]) || (you === optionValues[1] && computer === optionValues[2]) || (you === optionValues[2] && computer === optionValues[0])) {
