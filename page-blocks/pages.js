...
export function ResetPassword() {
  return `<section class="form-container">
    <form class="form sign-in reset-password">
...
<aside>
  <p><a class="back-button">Back to Home</a></p>
</aside>`;
}

export function RecoverPassword() {
  return `<section class="form-container">
    <div class="recover-password-instructions">Receive an email to recover password</div>
...
export function DeleteCurrentUser() {
  return `<section class="form-container">
    <div class="delete-instructions">This action is irreversible!!!</div>
